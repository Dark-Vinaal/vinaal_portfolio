...
const BentoCardGrid: React.FC<{
    ...
    <div
        className="bento-section grid gap-2 p-3 w-full max-w-6xl select-none relative mx-auto"
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="bento-grid">
                    {cards.map((card, index) => {
                        const baseClassName = `card flex flex-col justify-between relative min-h-[180px] w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${enableBorderGlow ? 'card--border-glow' : ''
                            }`;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="card__content flex flex-col relative text-white flex-1">
                                        ...
                                        <div className={`card__description text-sm leading-relaxed text-zinc-400 ${textAutoHide ? 'line-clamp-3' : ''}`}>
                                            {card.description}
                                        </div>
                                    </div>
                                </ParticleCard>
